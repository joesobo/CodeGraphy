...
*/
        ...
        var LayoutConstants =
          __webpack_require__(281).layoutBase.LayoutConstants;
        var FDLayoutConstants =
          __webpack_require__(281).layoutBase.FDLayoutConstants;
          ...
          _createClass(Layout, [
            {
              ...
              value: function run() {
                ...
                if (
                  options.fixedNodeConstraint &&
                  (!Array.isArray(options.fixedNodeConstraint) ||
                    options.fixedNodeConstraint.length == 0)
                ) {
                ...
                if (options.alignmentConstraint) {
                  if (
                    options.alignmentConstraint.vertical &&
                    (!Array.isArray(options.alignmentConstraint.vertical) ||
                      options.alignmentConstraint.vertical.length == 0)
                  ) {
                    options.alignmentConstraint.vertical = undefined;
                  }
                  if (
                    options.alignmentConstraint.horizontal &&
                    (!Array.isArray(options.alignmentConstraint.horizontal) ||
                      options.alignmentConstraint.horizontal.length == 0)
                  ) {
                ...
                if (
                  ...
                  (!Array.isArray(options.relativePlacementConstraint) ||
                    options.relativePlacementConstraint.length == 0)
                ) {
                ...
                if (eles.nodes().length > 0) {
                  ...
                  if (!packingEnabled) {
                    ...
                    if (components.length > 1) {
                      ...
                      var shiftResult = layUtil.packComponents(
                        subgraphs,
                        options.randomize
                      ).shifts;
                      if (options.quality == "draft") {
